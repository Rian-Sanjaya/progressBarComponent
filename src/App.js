...
export default class App extends React.Component {
  ...
  // listen for scroll event on the document object
  listenToScrollEvent = () => {
    // The method simply listens for any scroll event that takes place on the 
    // Document object and then invokes requestAnimationFrame, 
    //which notifies the browser that an animation is about to take place
  ...
  calculateScrollDistance = () => {
    ...
    // calculate the percentage a user has scrolled
    const totalDocScrollLength = docHeight - winHeight  // the total available scroll length of the document
